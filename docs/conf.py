...
"""
iknito-admin-panel documentation build configuration file.
...
project = 'iknito-admin-panel'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'iknito-admin-panel'
...
#
# html_title = 'iknito-admin-panel v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'admin panel for edx instance',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'iknito_admin_panel'),
                os.path.join(root_path, 'iknito_admin_panel/migrations')])
